...
const SPAWN_ROOMS: Array = [preload("res://Room/SpawnTest.tscn")]
const INTERMEDIATE_ROOMS: Array = [preload("res://Room/Room0.tscn")]
const END_ROOMS: Array = [preload("res://Room/EndRoom.tscn")]

const TILE_SIZE: int = 16
const FLOOR_TILE_INDEX: int = 19
const RIGHT_WALL_TILE_INDEX: int = 11
