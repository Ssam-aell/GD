...
const SPAWN_EXPLOSION_SCENE: PackedScene = preload("res://Character/Enemy/SpawnExplosion.tscn")
const ENEMY_SCENES: Dictionary = {"FLYING_CREATURE": preload("res://Character/Enemy/FlyingCreature/FlyingCreature.tscn")}
